...
func GetLogin() elem.Node {
	return elem.Section(attrs.Props{attrs.Class: "hero is-info is-fullheight is-widescreen"},
		elem.Div(attrs.Props{attrs.Class: "hero-body"},
			elem.Div(attrs.Props{attrs.Class: "container"},
				elem.Div(attrs.Props{attrs.Class: "columns is-centered"},
					elem.Div(attrs.Props{attrs.Class: "column is-5-tablet is-4-desktop is-3-widescreen"},
						elem.Div(attrs.Props{attrs.Class: "tile box is-ancestor"},
							elem.Div(attrs.Props{attrs.Class: "tile is-parent"},
								elem.Div(attrs.Props{attrs.Class: "tile is-child has-text-centered"},
									elem.Form(attrs.Props{attrs.Method: "post", attrs.Action: "/authenticate"},
