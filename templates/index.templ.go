		...
		elem.Body(nil,
			elem.Div(attrs.Props{attrs.ID: "outer"},
				...
				elem.Main(attrs.Props{attrs.Class: "main"},
					elem.Div(attrs.Props{attrs.Class: "columns"},
						elem.Div(attrs.Props{attrs.Class: "column is-one-quarter"},
							elem.Aside(attrs.Props{attrs.Class: "menu"},
								elem.P(attrs.Props{attrs.Class: "menu-label"},
									elem.Text("Test"),
								),
								elem.Ul(attrs.Props{attrs.Class: "menu-list"},
									elem.Li(nil, elem.A(nil, elem.Text("Punkt 1"))),
									elem.Li(nil, elem.A(nil, elem.Text("Punkt 2"))),
								),
							),
						),
